...
class Current_Stats_Overview:
    def __init__(self,root):
        ...
        self.var_52_week_high=IntVar() # self.var_serial_id
        self.var_date=StringVar() 
        self.var_52_week_low=IntVar()
        ...
        #=================Title======================
        lbl_title=Label(self.root,text="Indian Indices Overview", font=("times new roman",16,"bold"),bg="white",fg="black",bd=4,relief=RIDGE)
        lbl_title.place(x=0,y=0,width=1550,height=40) # width=1295

        #================lebel frame=================== 
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Nifty_50 Performance ",font=("times new roman",12,"bold"),padx=2) 
        labelframeleft.place(x=5,y=40,width=380,height=380)#width=400 y=35 height=440 
        
        #===============lables and entries================= #
        #serial_id No 
        lbl_serial_id_ref=Label(labelframeleft,text="52 Week High:-",font=("arial",11),padx=2,pady=6) 
        lbl_serial_id_ref.grid(row=3,column=0,sticky=W) 
        txtref=ttk.Entry(labelframeleft,width=25,textvariable=self.var_52_week_high,font=("arial",11,"bold")) 
        txtref.grid(row=3,column=1) 
        
        #Date 
        lbl_date_ref=Label(labelframeleft,text="Date:-",font=("arial",11),padx=2,pady=6) 
        lbl_date_ref.grid(row=9,column=0,sticky=W) 
        
        txtname=ttk.Entry(labelframeleft,width=25,textvariable=self.var_date,font=("arial",11,"bold")) 
        txtname.grid(row=9,column=1) 
        
        #Day Name 
        lbl_day_ref=Label(labelframeleft,text="52 Week Low:-",font=("arial",11),padx=2,pady=6) 
        lbl_day_ref.grid(row=2,column=0,sticky=W) 
        
        txtname=ttk.Entry(labelframeleft,width=25,textvariable=self.var_52_week_low,font=("arial",11,"bold")) 
        txtname.grid(row=2,column=1) 
        
        
        #Open Price 
        lbl_oprice_ref=Label(labelframeleft,text="Open:-",font=("arial",11),padx=2,pady=6) 
        lbl_oprice_ref.grid(row=4,column=0,sticky=W) 
        
        txtop=ttk.Entry(labelframeleft,width=25,textvariable=self.var_open_price,font=("arial",11,"bold")) 
        txtop.grid(row=4,column=1)#textvariable=self.var_mobile, 
        
        #Today's High 
        lbl_hprice_ref=Label(labelframeleft,text="Today's High:-",font=("arial",11),padx=2,pady=6) 
        lbl_hprice_ref.grid(row=1,column=0,sticky=W) 

        txthp=ttk.Entry(labelframeleft,width=25,textvariable=self.var_high_price,font=("arial",11,"bold")) 
        txthp.grid(row=1,column=1) 
      
        #Today's Low 
        lbl_lprice_ref=Label(labelframeleft,text="Today's Low:-",font=("arial",11),padx=2,pady=6) 
        lbl_lprice_ref.grid(row=0,column=0,sticky=W) 
        
        txtlp=ttk.Entry(labelframeleft,width=25,textvariable=self.var_low_price,font=("arial",11,"bold")) 
        txtlp.grid(row=0,column=1) 
        
        #Close Price 
        lbl_cprice_ref=Label(labelframeleft,text="Close:-",font=("arial",11),padx=2,pady=6) 
        lbl_cprice_ref.grid(row=5,column=0,sticky=W) 

        txtcp=ttk.Entry(labelframeleft,width=25,textvariable=self.var_close_price,font=("arial",11,"bold")) 
        txtcp.grid(row=5,column=1,sticky=W) 

        #Prev. Close Price 
        lbl_cprice_ref=Label(labelframeleft,text="Prev. Close:-",font=("arial",11),padx=2,pady=6) 
...
######
    ...
    def get_cursor(self,event=""):
        ...
        self.var_52_week_high.set(row[0]),
        self.var_date.set(row[1]),
        self.var_52_week_low.set(row[2]),
    ...
    def reset(self):
        self.var_52_week_high.set(""),
        self.var_date.set(""),
        self.var_52_week_low.set(""),
...
if __name__ == "__main__":
    root=Tk()
    obj=Current_Stats_Overview(root)
    root.mainloop()